...
public class Level implements Disposable{
    ...
    public ArrayList<Box2dRectangleObject> box2dRectangleObject;
    ...
    public void init() {
        ...
        box2dRectangleObject = new ArrayList<Box2dRectangleObject>();
    ...
    public void render(SpriteBatchWDebug batch, OrthographicCamera camera) {
        ...
        for(Box2dRectangleObject object:box2dRectangleObject){
            object.render(batch);
        }
    ...
    public class TileMapProcessor implements Disposable {
        ...
        int layerHightInTiles = layer.getHeight();
        ...
        for(int y=0;y<layer.getHeight();y++){
            for(int x=0;x<layer.getWidth();x++){
                ...
                if (layer.getCell(x, y) != null) {
                    ...
                    Gdx.app.debug(TAG, "createBox2dObject cell with texture x, y, w, h: " +
                            x + ", " + y + ", " +
                    ...
                    box2dRectangleObject.add(newDynamicObject);
